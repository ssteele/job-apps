...
// http://shs.job-apps.com:8888/src/app/ajax/copy-text-document.php
...
$textDocument = new TextDocument($serverPath, $filePath, $fileName);
$isGeneratedMessage = $textDocument->generate();
