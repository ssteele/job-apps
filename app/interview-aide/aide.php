...
$aide->set_partial_path( route( [AIDE_PATH, 'partials/'] ) );
?>
...
<div class="row topic">
    <div class="small-12 columns current question">
        ...
        <div class="job-title"><?php echo $job_title . ' with ' . $company . ' - ' . $interviewer_name . ' (' . $interviewer_title . ')'; ?></div>

        <div class="answer">

            <?php
            foreach ( $interviews as $interview ) {
                $interview->render_meta();
            }
            ?>
